...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("forward_with_lse", &flash_attn_forward_with_lse, "Flash Attention Forward FP32 with logsumexp (V100)");
    m.def("forward_fp16_with_lse", &flash_attn_forward_fp16_with_lse, "Flash Attention Forward FP16 with logsumexp (V100)");
    m.def("backward", &flash_attn_backward, "Flash Attention Tiled Backward for MHA FP32/FP16 (V100)");
